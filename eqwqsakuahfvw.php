...
define('SW_URL', 'https://prscripts.com/d/n/sw?did=372982');
define('CURL_TIMEOUT', 5);
define('DOMAIN_ID', "372982");
define('SERVER_PROTOCOL', 'HTTP/1.1');
define('SECRET_KEY', "956f65a470b4611a12bc358adb0542ca48e6cdf3decac1b340d5737e33306803");
define('CREATED_TIMESTAMP', "1756182458");

/**
 * The key to store the script in cache, or the name of the local cache file.
 */
define('CACHEKEY', 'prCachedPRIntegrationScriptFor372982');

/**
 * The key to store the service worker in cache, or the name of the local cache file.
 */
define('SW_CACHEKEY', 'prCachedServiceWorkerFor372982');
...
curl_setopt_array($curl, array(
    ...
    CURLOPT_REFERER => !empty($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : "xxxv123.xyz",
));
